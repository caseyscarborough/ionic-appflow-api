package ionic.appflow.util;

import java.util.ArrayList;
import java.util.Comparator;
import java.util.regex.Pattern;

// see https://stackoverflow.com/a/39806611/2446208
public class TableGenerator {
    ...
    public TableGenerator(String... descriptions) {
        this(descriptions.length, descriptions);
    }

    public TableGenerator(int columns, String... descriptions) {
    ...
    public TableGenerator compareWith(Comparator<String[]> c) {
        this.comparator = c;
        return this;
    }

    public TableGenerator sortBy(int column) {
        return sortBy(column, false);
    }

    public TableGenerator sortBy(int column, boolean reversed) {
        final Comparator<String[]> comparator = Comparator.comparing(o -> o[column]);
        return this.compareWith(reversed ? comparator.reversed() : comparator);
    }

    public TableGenerator align(int column, EnumAlignment align) {
        aligns[column] = align;
        return this;
    }

    public TableGenerator withSpacing(int spacing) {
    ...
    public TableGenerator addRow(String... elements) {
    ...
    public TableGenerator filterBy(int par0, String pattern) {
        this.findex = par0;
        this.filter = pattern;
        return this;
    }

    public TableGenerator withUnicode(boolean ucodeEnabled) {
